...
import { env, getSupabaseUrl, getSupabaseSecretKey } from './env'
...
export function createServiceSupabase() {
  ...
  if (
    ...
    throw new Error(
      'Supabase secret key is not configured. Set SUPABASE_SECRET_KEY (Vercel) or SUPABASE_SERVICE_ROLE_KEY.',
    )
  }
